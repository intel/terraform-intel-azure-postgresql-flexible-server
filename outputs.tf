...
output "db_server_sku" {
  ...
  value       = azurerm_postgresql_flexible_server.postgres.sku_name
}
...
output "db_resource_group_name" {
  ...
  value       = azurerm_postgresql_flexible_server.postgres.resource_group_name
}

output "db_location" {
  description = "Database instance location."
  value       = azurerm_postgresql_flexible_server.postgres.location
}
...
output "db_zone" {
  ...
  value       = azurerm_postgresql_flexible_server.postgres.zone
}

output "db_create_mode" {
  description = "The creation mode that was configured on the instance. "
  value       = azurerm_postgresql_flexible_server.postgres.create_mode
}
...
output "db_maintenance_window_day" {
  ...
  value       = try(azurerm_postgresql_flexible_server.postgres.maintenance_window[0].day_of_week, "")
}

output "db_maintenance_window_hour" {
  description = "Maintainence window for the database instance."
  value       = try(azurerm_postgresql_flexible_server.postgres.maintenance_window[0].start_hour, "")
}

output "db_maintenance_window_minute" {
  description = "Maintainence window for the database instance."
  value       = try(azurerm_postgresql_flexible_server.postgres.maintenance_window[0].start_minute, "")
}
...
output "db_ha_mode" {
  ...
  value       = try(azurerm_postgresql_flexible_server.postgres.high_availability[0].mode, "")
}
...
output "db_ha_standby_zone" {
  ...
  value       = try(azurerm_postgresql_flexible_server.postgres.high_availability[0].standby_availability_zone, "")
}
...
output "db_name" {
  ...
  value       = try(azurerm_postgresql_flexible_server_database.postgres[0].name, "")
}

output "db_collation" {
  description = "The Collation configured on the database."
  value       = try(azurerm_postgresql_flexible_server_database.postgres[0].collation, "")
}

output "db_charset" {
  description = "The Charset configured on the database."
  value       = try(azurerm_postgresql_flexible_server_database.postgres[0].charset, "")
}
...
output "db_backup_retention" {
  ...
  value       = azurerm_postgresql_flexible_server.postgres.backup_retention_days
}
...
output "db_restore_time" {
  ...
  value       = azurerm_postgresql_flexible_server.postgres.point_in_time_restore_time_in_utc
}
